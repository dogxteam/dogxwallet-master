#!/usr/bin/env python3
# Copyright (c) 2015-2019 The dogxcoin Core developers
...
class FullBlockTest(dogxcoinTestFramework):
    ...
    def run_test(self):
        ...
        target = uint256_from_compact(b47.ndogxs)
