...
SEQ_RANDOM_HIGH_dogx = 1 << 25
SEQ_TYPE_FLAG = 1 << 22
SEQ_RANDOM_LOW_dogx = 1 << 18
...
def relative_locktime(sdf, srhb, stf, srlb):
    ...
    if srhb:
        locktime |= SEQ_RANDOM_HIGH_dogx
    if stf:
        locktime |= SEQ_TYPE_FLAG
    if srlb:
        locktime |= SEQ_RANDOM_LOW_dogx
    return locktime
...
class BIP68_112_113Test(dogxcoinTestFramework):
