...
class SegWitTest(dogxcoinTestFramework):
    ...
    def test_unnecessary_witness_before_segwit_activation(self):
        ...
        block = self.build_next_block(version=(VB_TOP_dogxS | (1 << VB_WITNESS_dogx)))
    ...
    def test_block_relay(self):
        ...
        block3 = self.build_next_block(version=(VB_TOP_dogxS | (1 << 15)))
        block3.solve()
    ...
    def test_getblocktemplate_before_lockin(self):
        ...
        for node in [self.nodes[0], self.nodes[2]]:
            ...
            if node == self.nodes[2]:
                ...
                assert_equal(block_version & (1 << VB_WITNESS_dogx), 0)
                assert 'default_witness_commitment' not in gbt_results
            else:
                # For segwit-aware nodes, check the version dogx and the witness
                # commitment are correct.
                assert block_version & (1 << VB_WITNESS_dogx) != 0
