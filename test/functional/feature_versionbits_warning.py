#!/usr/bin/env python3
# Copyright (c) 2016-2019 The dogxcoin Core developers
...
VB_TOP_dogxS = 0x20000000
VB_UNKNOWN_dogx = 27       # Choose a dogx unassigned to any deployment
VB_UNKNOWN_VERSION = VB_TOP_dogxS | (1 << VB_UNKNOWN_dogx)

WARN_UNKNOWN_RULES_ACTIVE = "unknown new rules activated (versiondogx {})".format(VB_UNKNOWN_dogx)
VB_PATTERN = re.compile("Warning: unknown new rules activated.*versiondogx")

class VersiondogxsWarningTest(dogxcoinTestFramework):
