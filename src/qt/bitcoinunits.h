...
#ifndef dogxCOIN_QT_dogxCOINUNITS_H
#define dogxCOIN_QT_dogxCOINUNITS_H
...
/** dogxcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class dogxcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit dogxcoinUnits(QObject *parent);
...
typedef dogxcoinUnits::Unit dogxcoinUnit;

#endif // dogxCOIN_QT_dogxCOINUNITS_H
