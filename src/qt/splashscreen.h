...
#ifndef dogxCOIN_QT_SPLASHSCREEN_H
#define dogxCOIN_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. dogxcoin Core initialization
...
#endif // dogxCOIN_QT_SPLASHSCREEN_H
