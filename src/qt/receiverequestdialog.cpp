...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatdogxcoinURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + dogxcoinUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatdogxcoinURI(info));
}
