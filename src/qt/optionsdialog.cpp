    ...
    mapper(nullptr)
{
    ...
    ui->dogxcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->dogxcoinAtStartup);
    ...
    ui->opendogxcoinConfButton->setToolTip(ui->opendogxcoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new dogxcoinUnits(this));
...
void OptionsDialog::on_opendogxcoinConfButton_clicked()
{
