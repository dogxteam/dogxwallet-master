...
//! Entry point for dogxcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &dogxcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for dogxcoinGUI tests.
void AppTests::guiTests(dogxcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &dogxcoinGUI::consoleShown, this, &AppTests::consoleTests);
