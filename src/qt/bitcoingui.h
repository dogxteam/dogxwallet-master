...
#ifndef dogxCOIN_QT_dogxCOINGUI_H
#define dogxCOIN_QT_dogxCOINGUI_H
...
/**
  dogxcoin GUI main class. This class represents the main window of the dogxcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class dogxcoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit dogxcoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~dogxcoinGUI();
...
#endif // dogxCOIN_QT_dogxCOINGUI_H
