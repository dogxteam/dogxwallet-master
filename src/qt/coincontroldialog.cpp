...
{
    GUIUtil::setClipboard(dogxcoinUnits::removeSpaces(contextMenuItem->text(COLUMN_AMOUNT)));
}
...
void CoinControlDialog::updateLabels(WalletModel *model, QDialog* dialog)
{
    ...
    int nDisplayUnit = dogxcoinUnits::BTC;
    ...
    l2->setText(dogxcoinUnits::formatWithUnit(nDisplayUnit, nAmount));        // Amount
    l3->setText(dogxcoinUnits::formatWithUnit(nDisplayUnit, nPayFee));        // Fee
    l4->setText(dogxcoinUnits::formatWithUnit(nDisplayUnit, nAfterFee));      // After Fee
    l5->setText(((nBytes > 0) ? ASYMP_UTF8 : "") + QString::number(nBytes));        // Bytes
    l7->setText(fDust ? tr("yes") : tr("no"));                               // Dust
    l8->setText(dogxcoinUnits::formatWithUnit(nDisplayUnit, nChange));        // Change
    if (nPayFee > 0)
    {
...
void CoinControlDialog::updateView()
{
    ...
    for (const auto& coins : model->wallet().listCoins()) {
        ...
        for (const auto& outpair : coins.second) {
            ...
            // amount
            itemOutput->setText(COLUMN_AMOUNT, dogxcoinUnits::format(nDisplayUnit, out.txout.nValue));
        ...
        if (treeMode)
        {
            ...
            itemWalletAddress->setText(COLUMN_AMOUNT, dogxcoinUnits::format(nDisplayUnit, nSum));
