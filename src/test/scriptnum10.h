...
#ifndef dogxCOIN_TEST_SCRIPTNUM10_H
#define dogxCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from dogxcoin Core 0.10.0, for cross-comparison.
 */
public:
