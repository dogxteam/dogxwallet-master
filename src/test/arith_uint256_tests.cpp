...
#define CHECKdogxWISEOPERATOR(_A_,_B_,_OP_)                              \
...
BOOST_AUTO_TEST_CASE( dogxwiseOperators )
{
    ...
    CHECKdogxWISEOPERATOR(R1,R2,|)
    CHECKdogxWISEOPERATOR(R1,R2,^)
    CHECKdogxWISEOPERATOR(R1,R2,&)
    CHECKdogxWISEOPERATOR(R1,Zero,|)
    CHECKdogxWISEOPERATOR(R1,Zero,^)
    CHECKdogxWISEOPERATOR(R1,Zero,&)
    CHECKdogxWISEOPERATOR(R1,Max,|)
    CHECKdogxWISEOPERATOR(R1,Max,^)
    CHECKdogxWISEOPERATOR(R1,Max,&)
    CHECKdogxWISEOPERATOR(Zero,R1,|)
    CHECKdogxWISEOPERATOR(Zero,R1,^)
    CHECKdogxWISEOPERATOR(Zero,R1,&)
    CHECKdogxWISEOPERATOR(Max,R1,|)
    CHECKdogxWISEOPERATOR(Max,R1,^)
    CHECKdogxWISEOPERATOR(Max,R1,&)
