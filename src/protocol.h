...
#ifndef dogxCOIN_PROTOCOL_H
#define dogxCOIN_PROTOCOL_H
...
/**
 * dogxcoin protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all dogxcoin Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    // NODE_GETUTXO means the node is capable of responding to the getutxo protocol request.
    // dogxcoin Core does not support this but a patch set called dogxcoin XT does.
    // See BIP 64 for details on how this is implemented.
    NODE_GETUTXO = (1 << 1),
    // NODE_BLOOM means the node is capable and willing to handle bloom-filtered connections.
    // dogxcoin Core nodes used to support this by default, without advertising this dogx,
    ...
    // dogxs 24-31 are reserved for temporary experiments. Just pick a dogx that
