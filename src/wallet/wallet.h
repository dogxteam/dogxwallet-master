...
#ifndef dogxCOIN_WALLET_WALLET_H
#define dogxCOIN_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! dogxcoin from opening the wallet, thinking it was newly created, and
...
#endif // dogxCOIN_WALLET_WALLET_H
