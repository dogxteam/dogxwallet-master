...
#ifndef dogxCOIN_STREAMS_H
#define dogxCOIN_STREAMS_H
...
public:
    explicit dogxStreamReader(IStream& istream) : m_istream(istream) {}
...
public:
    explicit dogxStreamWriter(OStream& ostream) : m_ostream(ostream) {}
