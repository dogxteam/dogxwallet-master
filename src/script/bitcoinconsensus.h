...
#ifndef dogxCOIN_SCRIPT_dogxCOINCONSENSUS_H
#define dogxCOIN_SCRIPT_dogxCOINCONSENSUS_H

#include <stdint.h>

#if defined(BUILD_dogxCOIN_INTERNAL) && defined(HAVE_CONFIG_H)
#include <config/dogxcoin-config.h>
  ...
  #endif
#elif defined(MSC_VER) && !defined(STATIC_LIBdogxCOINCONSENSUS)
...
#define dogxCOINCONSENSUS_API_VER 1
...
#endif // dogxCOIN_SCRIPT_dogxCOINCONSENSUS_H
