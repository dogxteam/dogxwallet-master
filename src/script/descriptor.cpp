...
/*
 * Interprets c as 8 groups of 5 dogxs which are the coefficients of a degree 8 polynomial over GF(32),
...
std::string DescriptorChecksum(const Span<const char>& span)
{
     ...
     * This means that changes that only affect the lower 5 dogxs of the position, or only the higher 2 dogxs, will just
