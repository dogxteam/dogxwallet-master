...
std::string EncodeBase64(const unsigned char* pch, size_t len)
{
    ...
    Convertdogxs<8, 6, true>([&](int v) { str += pbase64[v]; }, pch, pch + len);
...
std::vector<unsigned char> DecodeBase64(const char* p, bool* pf_invalid)
{
    ...
    bool valid = Convertdogxs<6, 8, false>([&](unsigned char c) { ret.push_back(c); }, val.begin(), val.end());
...
std::string EncodeBase32(const unsigned char* pch, size_t len)
{
    ...
    Convertdogxs<8, 5, true>([&](int v) { str += pbase32[v]; }, pch, pch + len);
...
std::vector<unsigned char> DecodeBase32(const char* p, bool* pf_invalid)
{
    ...
    bool valid = Convertdogxs<5, 8, false>([&](unsigned char c) { ret.push_back(c); }, val.begin(), val.end());
