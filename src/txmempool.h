...
#ifndef dogxCOIN_TXMEMPOOL_H
#define dogxCOIN_TXMEMPOOL_H
...
public:
     ...
     * https://github.com/dogxcoin/dogxcoin/pull/14193 will fix it. No known code
     * in dogxcoin currently depends on second guarantee, but it is important to
