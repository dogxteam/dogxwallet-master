...
#ifndef dogxCOIN_INTERFACES_CHAIN_H
#define dogxCOIN_INTERFACES_CHAIN_H
...
//! internal workings of the dogxcoin node, and not being very convenient to use.
...
//!   asynchronously
//!   (https://github.com/dogxcoin/dogxcoin/pull/10973#issuecomment-380101269).
//!
//! * The relayTransactions() and submitToMemoryPool() methods could be replaced
//!   with a higher-level broadcastTransaction method
//!   (https://github.com/dogxcoin/dogxcoin/pull/14978#issuecomment-459373984).
//!
//! * The initMessages() and loadWallet() methods which the wallet uses to send
//!   notifications to the GUI should go away when GUI and wallet can directly
//!   communicate with each other without going through the node
//!   (https://github.com/dogxcoin/dogxcoin/pull/15288#discussion_r253321096).
class Chain
{
public:
    virtual ~Chain() {}
    ...
    //! https://github.com/dogxcoin/dogxcoin/issues/15355
...
#endif // dogxCOIN_INTERFACES_CHAIN_H
