# Support for Output Descriptors in dogxcoin Core

Since dogxcoin Core v0.17, there is support for Output Descriptors in the
...
on dogxcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing dogxcoin Core wallets, a convenience function `combo` is
...
All RPCs in dogxcoin Core will include the checksum in their output. Only
