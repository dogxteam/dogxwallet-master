# PSBT Howto for dogxcoin Core

Since dogxcoin Core 0.17, an RPC interface exists for Partially Signed dogxcoin
...
PSBT is an interchange format for dogxcoin transactions that are not fully signed
...
#### Multisig with multiple dogxcoin Core instances

Alice, Bob, and Carol want to create a 2-of-3 multisig address. They're all using
dogxcoin Core. We assume their wallets only contain the multisig funds. In case
