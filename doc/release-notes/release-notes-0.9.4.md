dogxcoin Core version 0.9.4 is now available from:
...
this update is incompatible with the dogxcoin system and could lead to consensus
forks.

dogxcoin Core released binaries from https://dogxcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~dogxcoin/+archive/ubuntu/dogxcoin
- A third-party or self-compiled dogxcoin Core

upgrade to dogxcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
