dogxcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/dogxcoin/files/dogxcoin/dogxcoin-0.5.4/
...
Fix dogxcoin-Qt notifications under Growl 1.3.
Increase required age of dogxcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxdogxcoin properly when installing dogxcoin-Qt over it. (Windows)
