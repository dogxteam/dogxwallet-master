dogxcoin Core version 0.16.0 is now available from:
...
dogxcoin Core now has more flexibility in where the wallets directory can be
...
------------------------------------
The minimum version of the GCC compiler required to compile dogxcoin Core is now 4.8. No effort will be
...
- #11074 `99ec126` Assert that CWallet::SyncMetaData finds oldest transaction (dogxonicEelis)
...
- #11087 `99bc0b4` Diagnose unsuitable outputs in lockunspent() (dogxonicEelis)
...
- #11571 `c95832d` Fixed a couple small grammatical errors (dogxsInMyBlood)
...
- #11073 `3bb77eb` Remove dead store in ecdsa_signature_parse_der_lax (dogxonicEelis)
