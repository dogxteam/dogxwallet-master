dogxcoin Core version 0.14.0 is now available from:
...
dogxcoin Core has supported automatically pruning the blockchain since 0.11. Pruning
...
When dogxcoin Core is out-of-sync on startup, a semi-transparent information
...
The Alert System was [disabled and deprecated](https://dogxcoin.org/en/alert/2016-11-01-alert-retirement) in dogxcoin Core 0.12.1 and removed in 0.13.0. 
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of dogxcoin Core. This was added in conjunction with
