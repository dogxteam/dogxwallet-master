...
// dogxcoin includes.
#include <..\src\script\dogxcoinconsensus.h>
...
int main()
{
    std::cout << "dogxcoinconsensus version: " << dogxcoinconsensus_version() << std::endl;
    ...
    auto op0Result = dogxcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, dogxcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
